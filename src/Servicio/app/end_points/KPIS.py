...
@api_router_kpis.get("/hive/", status_code=200, response_model=float)
def get_kpis_per_hive(    *,
    ...
    print("Numero de recomendaciones realizadas", number_of_measurements)
...
@api_router_kpis.get("/campaign/", status_code=200, response_model=float)
